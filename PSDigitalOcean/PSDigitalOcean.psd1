@{
    ...
    GUID              = '60644b12-e9de-4dce-aede-650d9a6d54ff'
    ...
    Description       = 'PSDigitalOcean is a PowerShell Module that interacts with DigitalOceans API'
    ...
    FunctionsToExport = @('Get-DOAccount.ps1',
                            'Get-DOAction.ps1',
                            'Get-DORegions.ps1',
                            'Get-DOVolume.ps1',
                            'Get-DOVolumes.ps1',
